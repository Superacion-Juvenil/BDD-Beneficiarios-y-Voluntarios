...
-- Se protege la identidad (id, CURP, fecha de nacimiento, sexo, createdAt) y
-- el estado administrativo (status). El participante sí elige su tipo de
-- participante, programa y zona/distrito desde su perfil.
